...
describe('ExampleController (gRPC e2e)', () => {
  ...
  describe('ExampleService.getAllExamplesList', () => {
    ...
    it('should search by example name', async () => {
      ...
      const dashboardExamples = result.items.filter((example: any) => example.name.toLowerCase().includes('dashboard'))
    ...
    it('should search by example type', async () => {
      ...
      const adminExamples = result.items.filter((example: any) => example.type.toLowerCase().includes('admin'))
  ...
  describe('Integration scenarios', () => {
    it('should create example and then retrieve it in list', async () => {
      ...
      const foundExample = listResult.items.find((example: any) => example._id.toString() === createdExampleId.toString())
    ...
    it('should handle multiple concurrent operations', async () => {
      ...
      const concurrentExamples = listResult.items.filter((example: any) => example.name === createExampleDto.name && example.type === createExampleDto.type)
